...
for row in clickstream_data:
    ...
    aggregated_data[url][country]['average_time'] = aggregated_data[url][country]['total_time'] / \
        aggregated_data[url][country]['clicks']
